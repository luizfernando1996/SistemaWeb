...
namespace SistemaWebProj.Controllers
{
    public class ClientePedidoController : Controller
    {
        ...
        {
            return View(db.ClientePedido.ToList());
        }
        ...
        public ActionResult Details(int? id)
        {
            ...
            ClientePedido clientePedido = db.ClientePedido.Find(id);
        ...
        public ActionResult Create([Bind(Include = "Id,numeroMesa,ValorTotal")] ClientePedido clientePedido)
        {
            ...
            {
                db.ClientePedido.Add(clientePedido);
                db.SaveChanges();
        ...
        {
            ClientePedido clientePedido = db.ClientePedido.Find(id);
            db.ClientePedido.Remove(clientePedido);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
